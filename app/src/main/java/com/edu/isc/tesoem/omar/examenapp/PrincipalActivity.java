...
public class PrincipalActivity extends AppCompatActivity {
    ...
    //Se declaran las variables para modificar la pregunta y las opciones y para calcular la putuacion
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Se le asigna a cada obejto el ID que va a usar
    ...
    public void Siguiente(View v){
        //if por si no marca niguna opcion
